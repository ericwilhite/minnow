import type { ColumnValues, LogicalType } from "@minnowdb/core/block-format";
...
/**
 * The comparison workload: 50 connected commerce tables ranging from compact dimensions to
 * multi-million-row transactional ledgers. Every suite and engine loads this one profile.
 */
export const commerceEntities: EntityDefinition[] = relationalCommerceEntities();

const relationalBaseRows = {
  countries: 8,
  regions: 16,
  currencies: 4,
  sales_channels: 6,
