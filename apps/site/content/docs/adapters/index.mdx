...
The [Kysely guide](/docs/adapters/kysely) covers inferred schema types, typed full-text search, live
queries, streaming, defaults, generated SQL, introspection, transactions, workers, and
embedded-database boundaries.
