...
ascending key components, dictionary probes for string keys. Anything the fast path cannot prove
— a pending update or delete delta, a cross-type comparison, a view, a domain-typed column —
