...
**Tabs are plural and mortal.** Several connections may open one database; readers keep a stable
version while writers publish new versions. Physical I/O may queue. A connection can die between
any two operations without corrupting anything. How you
