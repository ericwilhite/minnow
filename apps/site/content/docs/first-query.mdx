...
site runs against it for real — and its TypeScript tab is the same database through
[the typed client](/docs/client).
...
- [The typed client](/docs/client) — the optional builder, if you would rather write queries that
