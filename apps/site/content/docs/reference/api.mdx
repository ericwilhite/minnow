...
| `LiveQuerySetOptions / LiveQueryStats / LiveQueryInput`              | Hint/poll/`sharedResults` and `maxRetainedBytes` configuration, execution and retained-byte counters, and low-level query inputs.                                               |
