...
failed attempts retain and upload the complete profile with the trace, including a failed first
attempt whose retry passes. Library traces retain action timing, errors, sources, and attachments;
