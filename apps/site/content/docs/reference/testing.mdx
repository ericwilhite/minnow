...
the site runner can replace it. Persistent browser profile directories are excluded because they
contain browser caches rather than replay evidence. A console log alone is not a replay artifact.
