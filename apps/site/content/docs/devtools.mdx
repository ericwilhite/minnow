...
(the same [worker client](/docs/workers/) an app ships), loaded with a generated five-table
...
against a small in-memory database, see the [playground](/docs/playground/).
