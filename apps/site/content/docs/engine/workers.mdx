...
// The typed client wraps the worker client exactly as it wraps an in-worker database.
...
The typed client doesn't care about any of this: compiled plans cross the channel by structured
