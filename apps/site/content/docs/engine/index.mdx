...
| `compaction`       | `{}`          | Defaults for every fold this database plans, background ones included: `partitionRows` (16,384) bounds each level-one partition. See [partitioned folds](/docs/storage/maintenance#partitioned-folds). |
