...
| `coordinateWrites`            | —        | Deprecated and ignored since 0.11.0; removed in 0.12.0. Every writer takes a turn (see [writer turns](/docs/engine/transactions#conflicts)); there is no optimistic mode to select. Delete the option.            |
...
See [writer turns](/docs/engine/transactions#conflicts).
