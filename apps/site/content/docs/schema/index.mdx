...
narrow. Secondary indexes, triggers, named enum-type objects, and sequences remain SQL/Kysely
...
checksum-verified statistics that drive data skipping — so they cost one header read per
