...
// the framed bytes. The compatibility test calls this same function and compares every
// Minnow-owned byte after normalizing native gzip streams and their derived checksums.
  ...
  `${JSON.stringify(
    {
      ...
      // Deliberately not a timestamp: the logical artifact must stay stable across regenerations.
      // Native gzip bytes may differ, and the compatibility test normalizes only that output.
